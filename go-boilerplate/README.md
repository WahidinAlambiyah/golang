...
[![Go Build](https://github.com/WahidinAlambiyah/golang/actions/workflows/go.yml/badge.svg)](https://github.com/WahidinAlambiyah/golang/actions/workflows/go.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/WahidinAlambiyah/golang)](https://goreportcard.com/report/github.com/WahidinAlambiyah/golang)
[![CodeQL](https://github.com/WahidinAlambiyah/golang/actions/workflows/codeql.yml/badge.svg)](https://github.com/WahidinAlambiyah/golang/actions/workflows/codeql.yml)
[![Codacy Security Scan](https://github.com/WahidinAlambiyah/golang/actions/workflows/codacy.yml/badge.svg)](https://github.com/WahidinAlambiyah/golang/actions/workflows/codacy.yml)
...
> The first thing you should do is to change the package name, find `github.com/WahidinAlambiyah/golang` in all the files and replace it with your own package name. You can choose to use the general `github.com/(org-name)/(project-name)` naming pattern for consistency.
